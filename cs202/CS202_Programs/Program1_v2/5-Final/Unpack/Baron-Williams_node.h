...
class a_node: public action
{
  public:
    ...
    void set_next(a_node * src); //Sets the next node to passed in pointer
...
class d_node: public defend
{
  public:
    ...
    bool has_next() const;       //Checks if next pointer is pointing to NULL
    void set_next(d_node * src); //Sets the next node to passed in pointer
...
class s_node: public spell
{
  public:
    ...
    bool has_next() const;       //Checks if next pointer is pointing to NULL
    void set_next(s_node * src); //Sets the next node to passed in pointer
