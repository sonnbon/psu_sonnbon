...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~ C O N S T A N T S ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
const int SIZE = 31; //To be size of temporary arrays
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class card
{
  public:
    ...
    int copy_to(card & new_card);            //Copy to a passed in card object
...
class action: public card
{
  public:
    ...
    int copy_to(action & new_card);           //Copy to a passed in card object
...
class defend: public card
{
  public:
    ...
    int copy_to(defend & new_card);          //Copy to a passed in card object
...
class spell: public card
{
  public:
    ...
    int copy_to(spell & new_card);          //Copy to a passed in card object
