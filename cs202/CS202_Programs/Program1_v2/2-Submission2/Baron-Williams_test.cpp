...
// Filename: Baron-Williams_test.cpp
// *****************************************************************************
// PROGRESS SUBMISSION 2 - IN PROGRESS TESTING
...
{
  //Action deck
  a_deck a_deck_test1(10);
  a_deck a_deck_test2;

  //Defend deck
  d_deck d_deck_test1(10);
  d_deck d_deck_test2;

  //Spell deck
  s_deck s_deck_test1(10);
  s_deck s_deck_test2;
  ...
  //Test action cards
  cout << "ACTION CARD TESTING" << endl << endl;
  ...
  do
  {
    cout << "Choose an option:\n"
         ...
         << "11 - Copy all action deck\n"
         << "12 - Remove card from action deck\n"
         << "13 - Remove all cards in action deck\n"
         << "14 - \n"
         << endl;
    ...
    switch (menu_option)
    {
      ...
      case 7:
        ...
        break;
      case 8:
        a_deck_test1.insert(a_test1);
        a_deck_test1.insert(a_test2);
        a_deck_test1.insert(a_test3);
        a_deck_test1.insert(a_test4);
        a_deck_test1.insert(a_test5);
        a_deck_test1.insert(a_test6);
        break;
      case 9:
        a_deck_test1.display();
        break;
      case 10:
        a_deck_test1.display_all();
        a_deck_test2.display_all();
        break;
      case 11:
        a_deck_test2.copy_all(a_deck_test1);
        break;
      case 12:
        a_deck_test2.remove();
        break;
      case 13:
        a_deck_test1.remove_all();
        break;
      default:
        cout << "\nWrong choice. Bye." << endl << endl;
        break;
    }
  } while (menu_option > 0 && menu_option < 14);

  //Test defend cards
  cout << "DEFEND CARD TESTING" << endl << endl;
  ...
  do
  {
    ...
    switch (menu_option)
    {
      ...
      case 7:
        ...
        break;
      case 8:
        d_deck_test1.insert(d_test1);
        d_deck_test1.insert(d_test2);
        d_deck_test1.insert(d_test3);
        d_deck_test1.insert(d_test4);
        d_deck_test1.insert(d_test5);
        d_deck_test1.insert(d_test6);
        break;
      case 9:
        d_deck_test1.display();
        break;
      case 10:
        d_deck_test1.display_all();
        d_deck_test2.display_all();
        break;
      case 11:
        d_deck_test2.copy_all(d_deck_test1);
        break;
      case 12:
        d_deck_test2.remove();
        break;
      case 13:
        d_deck_test1.remove_all();
        break;
      default:
        cout << "\nWrong choice. Bye." << endl << endl;
        break;
  ...
  //Test spell cards
  cout << "SPELL CARD TESTING" << endl << endl;
  ...
  do
  {
    cout << "Choose an option:\n"
         ...
         << "9 - Display node\n"
         << "10 - Display all nodes\n"
         << "11 - Copy all spell deck\n"
         << "12 - Remove card from spell deck\n"
         << "13 - Remove all cards in spell deck\n"
         << "14 - \n"
         << endl;
    ...
    switch (menu_option)
    {
      ...
      case 7:
        ...
        break;
      case 8:
        s_deck_test1.insert(s_test1);
        s_deck_test1.insert(s_test2);
        s_deck_test1.insert(s_test3);
        s_deck_test1.insert(s_test4);
        s_deck_test1.insert(s_test5);
        s_deck_test1.insert(s_test6);
        break;
      case 9:
        s_deck_test1.display();
        break;
      case 10:
        s_deck_test1.display_all();
        s_deck_test2.display_all();
        break;
      case 11:
        s_deck_test2.copy_all(s_deck_test1);
        break;
      case 12:
        s_deck_test2.remove();
        break;
      case 13:
        s_deck_test1.remove_all();
        break;
      default:
        cout << "\nWrong choice. Bye." << endl << endl;
        break;
