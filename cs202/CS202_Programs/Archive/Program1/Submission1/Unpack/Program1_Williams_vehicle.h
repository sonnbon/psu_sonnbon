...
// on vehicle type specific aspects of an object (car and truck). 
...
// purpose, and display the object's information. The purpose of the truck 
// class is to manage a truck's specific information, including its number of 
// packages and its capacity while also inheritting from the vehicle class. The 
// truck subclass allows the user to focus in more on the internal behaviour and 
// characteristcs of the object, just as with the car class. With this class, 
// the user will be able to add a truck, add or remove a package, check if the 
// truck is full of packages, change the truck's capacity, and display an 
// object's information. In this hierarchy, the goal is for the car or truck 
// classes, derived from the vehicle class, to be created and navigated to and 
// from parking stalls to occupy within a city.
// *****************************************************************************
