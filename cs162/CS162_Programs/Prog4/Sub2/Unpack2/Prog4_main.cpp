...
// enter how many songs they want their song playlist to hold. This dynamically
// allocates the memory to create the playlist size. A menu is then displayed to
// the user, called by the function 'menu', letting them choose from five 
// options: 1 - Add new song, 2 - Display all songs, 3 - Display all songs that
// match a particular genre, 4 - Edit particular songs, and 5 - Exit the 
...
// menu, if the user chooses option 3, the member function, 'by_genre', gets 
// called and accessed by 'music_list'. The user is prompted to enter what genre
// they would like to search by. All song matches will be displayed to the user 
// or, if there are no matches, the user will be notified. In the main menu, if 
// the user chooses option 4, the member function, 'edit', will get called and 
// accessed by 'music_list'. This function allows the user to choose a specific 
// song from all of the added songs and edit any part of that song (artist, 
// title, genre, when they like to listen, or link). In the main menu, if the 
// user chooses option 5, the function, 'exit', gets called and displays an 
// exiting message. The program will exit the main menu.
// *****************************************************************************
