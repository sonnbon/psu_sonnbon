...
void copy_update(song & a_song,    //Copy's song edit to particular information
		 char update[], 
		 int choice);
...
int edit_choice(int num);          //User chooses which song they wish to edit
int edit_options();                //User chooses which part of a song they wish
                                   //to edit
...
{
    public:
      playlist();          //Constructor, initializes the data members
      ~playlist();         //Destructor, deallocates any dynamic members
      ...
      void by_genre();     //Searches for and displays songs by particular genre
      void edit();         //User edits information about a particular song
