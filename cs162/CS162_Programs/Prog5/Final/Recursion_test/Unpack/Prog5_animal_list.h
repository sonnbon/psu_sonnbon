...
int display_all(node * head);               //Displays all of the animals
...
void exit(node * & head,                    //Deallocates all memory from all
          new_animal * & favorite,          //structures and arrays, and exits
	  char * & choice);                 //the program.
