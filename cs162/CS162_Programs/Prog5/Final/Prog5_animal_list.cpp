...
void build(node * & head, new_animal * & favorite)
{
    ...
    cout << "You added " << favorite->name << " to your list!"
	 << endl << endl;
    if (favorite)             //ADDED POST COURSE
    {
      delete [] favorite->name;
      delete [] favorite->breed;
      delete [] favorite->likeability;
      delete [] favorite->fav_food;
      delete favorite;        //ADDED POST COURSE
      favorite = NULL;        //ADDED POST COURSE
    }
}
...
void display_all(node * head)
{
    ...
    else
    {
      ...
      while (current)
      {
	display_one(current);  //Displays the current data item
        cout << endl;
        current = current->next;     //Set pointer to its next node 
      }
    }
...
void display_breed(node * head, char * & breed_choice)
{
    ...
    if (breed_choice)                 //ADDED POST COURSE
    {
      delete [] breed_choice;         //ADDED POST COURSE
      breed_choice = NULL;            //ADDED POST COURSE
    }
}
...
void remove_animal(node * & head, char * & name_choice)
{
    ...
    if (name_choice)                        //ADDED POST COURSE
    {
      delete [] name_choice;                //ADDED POST COURSE
      name_choice = NULL;                   //ADDED POST COURSE
    }
}
...
void destroy(node * & head, new_animal * & favorite, char * & choice)
{
    ...
    if (favorite)
    {
      ...
      favorite->name = NULL;
      favorite->breed = NULL;
      favorite->likeability = NULL;
      favorite->fav_food = NULL;
...
void display_one(node * head)
{
    cout << "Name: " << head->data->name << endl;
    cout << "Breed: " << head->data->breed << endl;
    cout << "What you like about the animal: " << head->data->likeability 
	 << endl;
    cout << "Number of likes: " << head->data->rank << endl;
    cout << "The animals favorite food: " << head->data->fav_food << endl;
}    
