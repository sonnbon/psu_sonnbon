...
// array of tasks of the "queue" class data type and a next pointer to the node
// structure.
struct node
{
  queue * tasks; //Dynamically allocated array of tasks or steps of the "queue" 
                 //class data type
...
class stack
{
  public:
    ...
    int pop(queue & to_copy);       //Remove queue from the top of the stack and
                                    //copy its contents
