...
class queue
{
  public:
    ...
    int copy(const queue & to_copy);      //Copy a queue object
    int is_empty() const;                 //Checks if list is empty

  private:
    int copy(q_node * rear_to_copy);      //Copy a queue object's rear pointer
