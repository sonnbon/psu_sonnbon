...
struct vertex
{
       ...
       struct node * head;           //edge list, INCOMPLETE DECLARATION NEEDED FOR THIS TO WORK
                                     //That's why struct is written there, they are used when
                                     //the definition is later on and when it is a pointer only
};
